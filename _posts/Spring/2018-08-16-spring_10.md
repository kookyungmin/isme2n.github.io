...
title:  "[Spring] 10.SpringProject-persistence 계층"

subtitle: "[Spring] 10.SpringProject-persistence 계층"
...
<mapper namespace="BoardMapper">
	...
	<update id="update">
		...
		where bno = (select max(bno) from (select max(bno) from board) b)
	</update>
	<!-- 가장 최근에 삽입된 행 삭제 -->
	<delete id="delete">
		delete from board where bno = (select max(bno) from (select max(bno) from board) b)
	</delete>
	<!-- board 전체 행 조회 -->
