...
title:  "[IoT_Oracle] 10.NULL 조회와 집합연산자"

subtitle: "[IoT_Oracle] 10.NULL 조회와 집합연산자"
...
SELECT manager_id as 상사번호,first_name as 사원이름,employee_id as 사원번호
FROM employees
...
## 집합연산자: UNION, MINUS, INTERSECTION
